  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "hidden md:flex flex-col h-screen duration-300 ease-in-out transition-[width]",
...
>(
  (
    ...
    const button = (
      ...
      >
        {children}
        <span className={cn("transition-opacity duration-200", state === 'collapsed' ? 'opacity-0' : 'opacity-100')}>{props.title}</span>
      </Comp>
    )
